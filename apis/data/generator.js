...
function calculatePricePercentageForEachBanner(data) {
    data.sort(function (a, b) { return b.price - a.price; });
    var sum = 0;
    for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
        var price = data_1[_i].price;
        sum += price;
    }
    for (var key in data) {
...
function run(number) {
    return __awaiter(this, void 0, void 0, function () {
        var start, banners, i, bannerObj;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Banner_1.default.collection.drop()];
                case 1:
                    _a.sent();
                    start = Date.now();
                    banners = [];
                    ...
                    return [4 /*yield*/, Banner_1.default.insertMany(banners)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
